...
{
    /// <summary>
    /// Represents a Skill Part and all the elements (other <see cref="Part"/>s) that might be necessary to completely describe it.
    /// </summary>
    public class Part
    {
        ...
        public IReadOnlyCollection<Part> Skills { get => _skills; }

        public Part(Name name)
        {
            Name = name;
        }
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public bool TryAdd(Guid parentId, Part skill)
        {
            if (Id == parentId)
            {
                Add(skill);
